...
namespace Tests
{
    ...
    {
//        string _host = "http://127.0.0.1:80";
...
//
//         [UnityTest]
//         public IEnumerator Logic_Flow()    // (2) DONE
//         {
//             var apiClient = new ApiClient(_host, _deviceId, _requestTimeout);
//             EncryptionHelper encryptionHelper = new EncryptionHelper();
//             bool isSending = true;
//
//             // post 
//             var requestData = new RequestData { deviceId = _deviceId };
//
//             Byte[] payload = Encoding.Unicode.GetBytes( JsonUtility.ToJson( requestData ) );
//             string payloadBase64 = Convert.ToBase64String( encryptionHelper.Encrypt( payload , apiClient.nonce ) );
//             
//             var postForm = new RawJsonForm();
//             postForm.AddField("payloadBase64", payloadBase64);
//             
...
//             Byte[] nonceByte = BitConverter.GetBytes( apiClient.nonce ); // nonce to byte
//             Byte[] signMessage = new Byte[108]; // nonceByte + digest
//             
//             Array.Copy( nonceByte , signMessage , nonceByte.Length );
//             Array.Copy( digest , 0 , signMessage , nonceByte.Length , digest.Length );
//             
//             signMessage = encryptionHelper.SignMessage( signMessage );
...
//
//         [UnityTest]
//         public IEnumerator Login_EmptyRequest_UnityWebRequest()    // (1) DONE
//         {
//             var url = $"{_host}/users/login";
//             WWWForm form = new WWWForm();
//             using (UnityWebRequest www = UnityWebRequest.Post(url, form))
...
//         
//         [UnityTest]
//         public IEnumerator Login_Success() // (3) DONE
//         {
//             var apiClient = new ApiClient(_host, _deviceId, _requestTimeout);
//             apiClient.Login();
//             yield return AssertLoginSuccess(apiClient);
...
//         
//         [UnityTest]
//         public IEnumerator Login_InvalidDeviceId()    // (5) DONE
//         {
//             var apiClient = new ApiClient(_host, "not 32 bytes", _requestTimeout);
//             apiClient.Login();
//             yield return AssertApiError(apiClient, ErrorCode.InvalidDeviceId);
...
//         
//         [UnityTest]
//         public IEnumerator Login_InvalidVersion()        // (4) DONE
//         {
//             var apiClient = new ApiClient(_host, _deviceId, _requestTimeout);
//             apiClient.Version = "2.0";
//             apiClient.Login();
